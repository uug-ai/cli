...
func organisationsBackfillAdapters() map[string]organisationsBackfillAdapter {
	return map[string]organisationsBackfillAdapter{
		...
		"workflow_runs": {
			...
			MinimumWriterVersions: []string{"hub-workflows:v1.0.25"},
			MinimumReaderVersions: []string{"hub-api:unreleased-PR557", "hub-workflows:unreleased-PR61", "hub-cleanup:unreleased-PR44"},
		},
		"videowalls": {
